...
public class DeclarationController {
    ...
    @PostMapping
    public ResponseEntity<DeclarationResponse> create(@Valid @RequestBody CreateDeclarationRequest request, @AuthenticationPrincipal UserEntity authenticatedUser) {
